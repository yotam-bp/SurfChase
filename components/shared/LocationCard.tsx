  ...
  return (
    <div className="group relative flex min-h-[380px] w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-white shadow-md transition-all hover:shadow-lg md:min-h-[438px]">
      ...
      <div className="absolute right-2 top-2 flex flex-col gap-4 rounded-xl bg-white p-2 shadow-sm transition-all">
        ...
        <button onClick={handleFavoriteToggle}> {/* <-- Added button for favorite toggle */}
          <Image
            src={isFavorite ? "/assets/icons/heart-filled.svg" : "/assets/icons/heart.svg"} // <-- Updated to conditionally show filled or empty heart
            alt="Favorite"
            width={24}
            height={24}
          />
